  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to Elastic BNB.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
            ...
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, Elastic BNB burns the CAKE.')}
              <br />
          ...
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with Elastic BNB, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
